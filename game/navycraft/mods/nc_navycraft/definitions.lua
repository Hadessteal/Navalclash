...
D.craft_types = {
    ...
    ship = {drive_command="sail", min_blocks=50, max_blocks=18000, max_speed=6, can_navigate=true,
        can_fly=false, can_dive=false, can_dig=false, terrestrial=false, obeys_gravity=false,
    ...
    freeship = {drive_command="sail", min_blocks=50, max_blocks=3000, max_speed=6, can_navigate=true,
        can_fly=false, can_dive=false, can_dig=false, terrestrial=false, obeys_gravity=false,
    ...
    halfship = {drive_command="sail", min_blocks=50, max_blocks=3000, max_speed=6, can_navigate=true,
        can_fly=false, can_dive=false, can_dig=false, terrestrial=false, obeys_gravity=false,
        cruise=true, max_engine_speed=8, max_forward_gear=2, max_reverse_gear=-2,
